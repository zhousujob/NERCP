...
wna=[1e-3,1e-3,1e-3]
freq_norm=[0.7,0.7,0.7]
emic_intensity=[3*10**(-9),3*10**(-9),3*10**(-9)]

Energy=[50,50,50]  #initial energy keV
pitch_angle=[40,41,42]
...
ylim_aeq_lat_0=[30,80]
ylim_aeq_lat_1=[30,80]
ylim_aeq_lat_2=[30,80]



ylim_daeq_eta_0=[-10,30]
ylim_daeq_eta_1=[-10,30]
ylim_daeq_eta_2=[-10,30]
...
hf=numlib.axes_create(row=num_row, column=num_column,top=0.04,bottom=0.05,left=0.05,right=0.06,gap_row=0.055,gap_column=0.06)
...
for iPar in range(len(wna)):
    ...
    hf[axes_num].set_xlabel(r'Latitude $\rm\lambda\ (deg)$',fontsize=LabelSize)
    ...
    hf[axes_num].text(x=0.5,y=1.05,s=r'$\rm\omega$='+str(freq_ratio)+r'$\rm\Omega_{He\_eq}$, '+r'$\rmE_{k0}$='+str(Ekev0)+r' keV, $\rm\alpha_{eq0}$='+str(aeq0_deg)+r'$\rm\degree$',fontsize=LabelSize+1,ha='center',transform=hf[axes_num].transAxes)
    ...
    hf[axes_num].set_ylabel(r'$\rm\alpha_{eq}$ (deg)',fontsize=LabelSize)
    ...
    hf[axes_num].set_ylabel(r'$\Delta \alpha_{\rmeq}$ (deg)',fontsize=LabelSize)
...
axes_num=0
hf[axes_num].annotate(text='phase trapping',color='k',fontsize=LabelSize+1,xy=(0.18,0.6),\
    xycoords='axes fraction',xytext=(0.25,0.8),va='center',textcoords='axes fraction',arrowprops=dict(color='k',headwidth=9,width=1))
  
    
axes_num=1
hf[axes_num].annotate(text='phase bunching',color='k',fontsize=LabelSize+1,xy=(0.81,0.88),\
    xycoords='axes fraction',xytext=(0.15,0.9),va='center',textcoords='axes fraction',arrowprops=dict(color='k',headwidth=9,width=1))

axes_num=1
hf[axes_num].annotate(text='phase trapping',color='k',fontsize=LabelSize+1,xy=(0.11,0.48),\
    xycoords='axes fraction',xytext=(0.06,0.13),va='center',textcoords='axes fraction',arrowprops=dict(color='k',headwidth=9,width=1))
   
axes_num=2
hf[axes_num].annotate(text='phase bunching',color='k',fontsize=LabelSize+1,xy=(0.79,0.75),\
    xycoords='axes fraction',xytext=(0.17,0.9),va='center',textcoords='axes fraction',arrowprops=dict(color='k',headwidth=9,width=1))

axes_num=2
hf[axes_num].annotate(text='phase trapping',color='k',fontsize=LabelSize+1,xy=(0.28,0.38),\
...
for iP in range(len(hf)):
    hf[iP].text(x=0.01,y=0.91,s=panel_label[iP],color='k',weight='bold',bbox=dict(facecolor='w',edgecolor='None',alpha=0.35),fontsize=LabelSize+2,transform=hf[iP].transAxes)


  

fig_name='trajectory_EMIC_freq_aeq404142'
if save is True:
