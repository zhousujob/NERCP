...
emic_intensity=[0.1*10**(-9),1*10**(-9),3*10**(-9)]

Energy=[50,50,50]  #initial energy keV
pitch_angle=[60,60,60]
...
xlim_aeq_lat=[0,15]
ylim_aeq_lat_0=[59.8,60.2]
ylim_aeq_lat_1=[58,63]
ylim_aeq_lat_2=[50,80]


ylim_daeq_eta_0=[-0.2,0.2]
ylim_daeq_eta_1=[-4,4]
ylim_daeq_eta_2=[-10,20]


ylim_Ek_lat_0=[49.95,50.05]
ylim_Ek_lat_1=[49.4,50.6]
ylim_Ek_lat_2=[48,54]


ylim_dEk_eta_0=[-0.05,0.05]
ylim_dEk_eta_1=[-0.6,0.6]
ylim_dEk_eta_2=[-2,3]
...
for iPar in range(len(wna)):
    ...
    hf[axes_num].text(x=0.5,y=1.05,s=r'$\rmB_w^y$='+str(round(Byw0_sim*1e9,1))+' nT',fontsize=LabelSize+2,ha='center',transform=hf[axes_num].transAxes)
...
hf[axes_num].annotate(text='phase bunching',color='k',fontsize=LabelSize+1,xy=(0.77,0.95),\
    xycoords='axes fraction',xytext=(0.15,0.6),va='center',textcoords='axes fraction',arrowprops=dict(color='k',headwidth=9,width=1))

axes_num=2
hf[axes_num].annotate(text='phase bunching',color='k',fontsize=LabelSize+1,xy=(0.79,0.85),\
    xycoords='axes fraction',xytext=(0.83,1.07),va='center',textcoords='axes fraction',arrowprops=dict(color='k',headwidth=9,width=1))

axes_num=2
hf[axes_num].annotate(text='phase trapping',color='k',fontsize=LabelSize+1,xy=(0.395,0.6),\
    xycoords='axes fraction',xytext=(0.2,0.85),va='center',textcoords='axes fraction',arrowprops=dict(color='k',headwidth=9,width=1))
