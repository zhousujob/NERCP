...
xlim_eta_lat=[0,20]
xticks_eta_lat=range(0,21,2)

ylim_s_lat=[-4,0]


xlim_aeq_lat=[0,20]
xticks_aeq_lat=range(0,21,2)


ylim_aeq_lat_0=[40,90]
ylim_aeq_lat_1=[46,55]
ylim_aeq_lat_2=[49.7,50.3]


ylim_daeq_eta_0=[-10,40]
ylim_daeq_eta_1=[-5,5]
ylim_daeq_eta_2=[-0.3,0.3]



ylim_Ek_lat_0=[48,58]
ylim_Ek_lat_1=[49,51]
ylim_Ek_lat_2=[49.9,50.1]


ylim_dEk_eta_0=[-2,8]
ylim_dEk_eta_1=[-1,1]
ylim_dEk_eta_2=[-0.1,0.1]
...
for iPar in range(len(wna)):
    ...
    hf[axes_num].text(x=0.5,y=1.05,s=r'$\rm\psi=$'+str(theta0_nh_deg)+r'$\rm\degree$',\
    ...
    hf[axes_num].set_xticks(xticks_aeq_lat)
    if iPar==0:
...
axes_num=0
hf[axes_num].annotate(text='phase bunching',color='k',fontsize=LabelSize+1,xy=(0.76,0.96),\
    xycoords='axes fraction',xytext=(0.8,1.08),va='center',textcoords='axes fraction',arrowprops=dict(color='k',headwidth=9,width=1))

axes_num=0
hf[axes_num].annotate(text='phase trapping',color='k',fontsize=LabelSize+1,xy=(0.17,0.66),\
    xycoords='axes fraction',xytext=(0.21,0.85),va='center',textcoords='axes fraction',arrowprops=dict(color='k',headwidth=9,width=1))
   
axes_num=1
hf[axes_num].annotate(text='phase bunching',color='k',fontsize=LabelSize+1,xy=(0.69,0.05),\
    xycoords='axes fraction',xytext=(0.1,0.2),va='center',textcoords='axes fraction',arrowprops=dict(color='k',headwidth=9,width=1))
