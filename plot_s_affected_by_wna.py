...
for iPar in range(len(theta0_deg)):
    ...
    manual_0 = [(25,2.5),(37,2.5),(70,2.4),(75,2)]

    manual_1 = [(30,2.5),(45,2.4),(60,1.3),(65,1)]
    manual_2 = [(27,2),(32,1.5),(37,0.55),(40,0.3)]
    if iPar==0:
    ...
    hf[axes_num].text(x=0.5,y=1.04,s=r'$\rm\psi$='+str(theta0_deg[iPar])+r'$\rm\degree$',\
