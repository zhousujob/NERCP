...
for iPar in range(len(emic_by)):
    ...
    manual_0 = [(80,2.5),(85,2.5)]

    manual_1 = [(40,2.5),(53,2.5),(78,2.5),(85,2.5)]
    ...
    hf[axes_num].text(x=0.5,y=1.04,s=r'$\rmB_{w}^{y}$='+str(round(Byw0_sim*1e9,1))+' nT',\
